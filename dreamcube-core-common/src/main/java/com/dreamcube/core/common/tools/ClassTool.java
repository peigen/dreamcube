...
public class ClassTool {
	...
	public static String getClassNameForObjectAsResource(Object object) {
		...
		return object.getClass().getName().replace(PACKAGE_SEPARATOR_CHAR,
	...
	public static boolean isInnerClass(Class clazz) {
		...
		return StringTool.contains(clazz.getName(), INNER_CLASS_SEPARATOR_CHAR);
	}
	...
	public static boolean isAssignable(Class[] classes, Class[] fromClasses) {
		if (!ArrayTool.isSameLength(fromClasses, classes)) {
			return false;
		}

		if (fromClasses == null) {
			fromClasses = ArrayTool.EMPTY_CLASS_ARRAY;
		}

		if (classes == null) {
			classes = ArrayTool.EMPTY_CLASS_ARRAY;
		}
