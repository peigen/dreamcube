...
public class DateTool {
    Logger                     log             = Logger.getLogger(DateTool.class);
    ...
    public static String getNextMon(String StringDate) throws ParseException {
        Date tempDate = DateTool.shortstring2Date(StringDate);
        Calendar cad = Calendar.getInstance();
        cad.setTime(tempDate);
        cad.add(Calendar.MONTH, 1);
        return DateTool.shortDate(cad.getTime());
    }
    ...
    public static String getNextDay(String StringDate) throws ParseException {
        Date tempDate = DateTool.string2Date(StringDate);
        Calendar cad = Calendar.getInstance();
        cad.setTime(tempDate);
        cad.add(Calendar.DATE, 1);
        return DateTool.dtSimpleFormat(cad.getTime());
    }
    ...
    public static long countDays(String startDate, String endDate) {
        ...
        long days = 0;
        try {
            tempDate1 = DateTool.string2Date(startDate);
            tempDate2 = DateTool.string2Date(endDate);
