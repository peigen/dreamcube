...
public class ObjectTool {
    ...
    public static Object clone(Object array) throws CloneNotSupportedException {
        ...
        try {
            Method cloneMethod = clazz.getMethod("clone", ArrayTool.EMPTY_CLASS_ARRAY);
    ...
    public static String toString(Object object) {
        return (object == null) ? StringTool.EMPTY_STRING
            : (object.getClass().isArray() ? ArrayTool.toString(object) : object.toString());
    }
    ...
    public static String toString(Object object, String nullStr) {
        return (object == null) ? nullStr : (object.getClass().isArray() ? ArrayTool
