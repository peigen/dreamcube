 ...
 * <tt>com.dreamcube.core.dal.daointerface.DcSquadDAO</tt>.
 * 
 * This file is generated by <tt>dreamcube-dalgen</tt>, a DAL (Data Access
 ...
 * configuration file (<tt>tables/dc_squad.xml</tt>). Modify the configuration
 * file according to your needs, then run <tt>dreamcubedalgen</tt> to generate
 * this file.
 * 
 * @author peigen
 */
@SuppressWarnings("unchecked")
public class IbatisDcSquadDAO extends SqlMapClientDaoSupport implements
		DcSquadDAO {
	/**
	 * Insert one <tt>DcSquadDO</tt> object to DB table <tt>dc_squad</tt>,
	 * return primary key
	 * 
	 * <p>
	...
	public DcSquadDO loadById(long id) throws DataAccessException {
		...
		return (DcSquadDO) getSqlMapClientTemplate().queryForObject(
				"MS-DC-SQUAD-LOAD-BY-ID", param);
	...
	public DcSquadDO loadByName(String squadName) throws DataAccessException {
		...
		return (DcSquadDO) getSqlMapClientTemplate().queryForObject(
				"MS-DC-SQUAD-LOAD-BY-NAME", squadName);
	...
	public int deleteById(long id) throws DataAccessException {
		...
		return getSqlMapClientTemplate().delete("MS-DC-SQUAD-DELETE-BY-ID",
				param);
	}
	 ...
	 * @throws DataAccessException
	 */
	public PageList query(String squadName, String axiser, String cubers,
			String followers, String investors, String status, Date gmtCreate,
